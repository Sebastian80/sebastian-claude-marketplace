...
def extract_marketplace_from_path(manifest_path: Path) -> str | None:
    ...
    Example:
        Path: ~/.claude/plugins/marketplaces/sebastian-marketplace/
              plugins/jira/skills/jira/manifest.json
...
def is_plugin_enabled(plugin_name: str, manifest_path: Path, installed_plugins: set[str]) -> bool:
    ...
    if "/skills/" in path_str:
        ...
        # Example: .../plugins/jira/skills/jira/manifest.json -> "jira"
        # Example: .../plugins/serena-integration/skills/serena/... -> "serena-integration"
